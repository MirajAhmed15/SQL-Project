...
GO 
--Delete procedure
--First check if any book exist for the author
--if exist and cascade enable (@cascade = 1) delete associated entries in bookauthos and then delete author
...
GO
--delete procedure
--First check if any book exist for the tag
--if exist and cascade enable (@cascade = 1) delete associated entries in bookauthos and then delete author
-- otherwise raise error
GO
...
-- Procedures for publisher table
-----------------------------------------------
...
BEGIN
	...
	raiserror ('Cannot delete publicher, publisher has related books', 11, 1)
	return
END
ELSE
BEGIN
...
--View author and number of books written
